<?php
	require 'connect.php';
	$query = 'SELECT * FROM ElencoAccessi WHERE OraUscita="00:00:00"';
	...
	if (0 == mysql_num_rows($result)) {
		...
		while ($row = mysql_fetch_array($result)) {
			...
			'<a href="nuovo_accesso2.html?ID='.$id.'"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="" onClick="del('.$id.')"><i class="fa fa-trash"></i></a>'
